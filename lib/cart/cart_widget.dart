...
class _CartWidgetState extends State<CartWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.total = functions.sumarLista(
          FFAppState().carItems.map((e) => e.price).toList().toList());
      setState(() {});
    });
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final cart = FFAppState().carItems.toList();
                        if (cart.isEmpty) {
                                ...
                                Expanded(
                                  child: FutureBuilder<List<ProductsRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<ProductsRow> cardProductsRowList =
                                          snapshot.data!;
                                      final cardProductsRow =
                                          cardProductsRowList.isNotEmpty
                                              ? cardProductsRowList.first
                                              : null;
                                      return Card(
                                        clipBehavior:
                  ...
                  if (FFAppState().carItems.length != 0)
                    Padding(
                      padding:
